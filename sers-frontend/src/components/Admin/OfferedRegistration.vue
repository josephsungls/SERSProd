        ...
        <table class = "table">
            ...
            <tbody v-if="registrations.length != 0">
                <tr v-for="course in registrations" :key="course">
                    ...
                    <td  @click="enterCourse(course)"> <br> {{course.User_Name? processInstructors(course.User_Name) : course.User_Name}}</td>
                    ...
                    <td class = "text-center">
                        <br> 
                        <span :class="['badge', 'badge-pill', course.Run_Status]"  data-toggle="modal" data-target="#changeStatus"  @click="changeCurrent(course)" > 
                            {{course.Run_Status}}
                       </span>
                    </td>
