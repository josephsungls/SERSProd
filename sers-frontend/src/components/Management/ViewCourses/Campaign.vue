        ...
        <div class="table-container" v-if="tabs.current">
            ...
            <table class = "table">
                ...
                <tbody v-if="filtered_courses.length > 0">
                    <template v-for="course in filtered_courses">
                         {{getCurrentYears(course.Vote_End)}}
                        <tr  :key="course" v-if="selected_current=='All' || selected_current == getYear(course.Vote_End)">
        ...
        <div class="table-container" v-else>
            ...
            <table class = "table">
                ...
                <tbody v-if="filtered_courses_closed.length > 0">
                    <template v-for="course in filtered_courses_closed" >
                        {{getEndedYears(course.Vote_End)}}
                        <tr :key="course" v-if="selected_ended=='All' || selected_ended == getYear(course.Vote_End)">
